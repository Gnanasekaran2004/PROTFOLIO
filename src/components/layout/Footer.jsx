        ...
        <footer className="bg-white dark:bg-primary-950 border-t border-primary-200 dark:border-primary-800">
            <div className="max-w-6xl mx-auto px-6 py-6">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    {/* Animated Social Links Loop - Right Side */}
                        ...
                        <div className="flex gap-10 animate-scroll-loop hover:[animation-play-state:paused]">
                            ...
                            {socialLinks.map((link, index) => (
                                <a
                                    ...
                                    className="flex-shrink-0 text-primary-600 dark:text-primary-400 hover:text-accent dark:hover:text-accent transition-all duration-300 hover:scale-110"
