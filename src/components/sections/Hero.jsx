...
const Hero = () => {
    ...
    return (
        <section
            className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-primary-50 dark:from-primary-950 dark:to-primary-900 pt-20 relative overflow-hidden"
        ...
        >
                    ...
                    >
                        <div className="absolute inset-0 bg-gradient-to-br from-primary-800/60 to-primary-950/60 dark:from-primary-900/50 dark:to-black/50 rounded-3xl overflow-hidden z-10">
                            ...
                            <div className="absolute top-0 left-0 right-0 z-20 p-6 text-center bg-gradient-to-b from-black/30 to-transparent">
                                ...
                                <p className="text-sm text-primary-200 font-medium drop-shadow-md">
                            ...
                            <div className="relative h-full">
                                <img
                                    src={require('../assest/unnamed.jpg')}
                                    alt="Gnanasekaran D"
            ...
            {/* Main Content - Fades when card is expanded */}
            <motion.div
